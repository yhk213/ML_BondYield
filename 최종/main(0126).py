...
# archi : for macro layer. 
# using fwd-rate directly at last (hidden) layer
# when archi = [32, 16], 128>32>16 + 10 (=26) > 1
# Using SGD / drop-out for training
# Early-stopping is defined in FunLib
